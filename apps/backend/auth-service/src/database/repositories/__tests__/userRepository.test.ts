...
import { UserModel, ICreateUser, IUpdateUser } from '@/src/database/models/user.model';
import { UserRepositories } from '@/src/database/repositories/auth.repository'; // Adjust the path to your UserRepositories
