            ...
            <form className="w-[100%] text-Black">
              <div className="w-[100%] grid gap-4 grid-cols-2 mt-[20px]">
                <div className="w-[100%] block mt-[5px]">
                  <Input placeholder='Property Title' name='title.0.content' errorMsg={true} className='bg-BgSoftWhite rounded-md border-[1.5px] border-[#D9D9D9]' onChange={handleInputChange} values={''} title='Title*' />
                </div>
                <div className="w-[100%] block mt-[5px]">
                  <Input placeholder='Property Slug' name='slug.0.content' errorMsg={true} className='bg-BgSoftWhite rounded-md border-[1.5px] border-[#D9D9D9]' onChange={handleInputChange} values={''} title='Slug(auto)' />
                </div>
              </div>
