  ...
  return (
    <div className="w-[100%] h-auto bg-BgSoftWhite mt-[40px] rounded-lg">
      <div className="flex justify-between p-[20px] items-center">
        ...
        <Link href={"/add_new_property"}>
                <button className="bg-Primary py-[8px] px-[16px] rounded-sm text-[16px] text-BgSoftWhite">+New Property</button>
        </Link>
      </div>
      ...
      <div className="w-[100%] p-[12px] text-[14px] text-Black font-DM Sans flex justify-between ">
          ...
          <div className="flex justify-between items-center  w-[60%] ">
              <div className='w-[200px] flex justify-start'> <p>Sale/Rent</p></div>
              <div className='w-[200px] flex justify-start'><p>Categories</p></div>
              <div className='w-[200px] flex justify-start'><p>Location</p></div>
              <div className='w-[200px] flex justify-start'> <p>Price</p></div> 
          </div>
