...
// const TotalPropertyData = () => {
//   const { fetchProperties, properties, loading } = useProperties(); // Fetch properties and pagination from context
//   const [currentMonthProperties, setCurrentMonthProperties] = useState<number>(0);
//   const [previousMonthProperties, setPreviousMonthProperties] = useState<number>(0);
...
//     const fetchData = async () => {
//       try {
//         await fetchProperties({ page: 1, limit: 1000 }); // Fetch all properties (adjust limit if needed)
//       } catch (err) {
//         console.error("Error fetching properties:", err);
//       }
//     };
...
//         const propertyDate = new Date(property.createdAt);
//         return (
//           propertyDate.getMonth() === previousMonth &&
//           propertyDate.getFullYear() === previousYear
//         );
//       }).length;
...
//     }
//     const difference = currentMonthProperties - previousMonthProperties;
//     return (difference / previousMonthProperties) * 100;
//   };
