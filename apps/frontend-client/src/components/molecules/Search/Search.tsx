...
// //     // Add transition filter based on selected category
// //     if (category) {
// //       params.append("category", category); // Use 'transition' as the filter key
// //     }
...
//                 <button
//                   className={`px-5 text-[18px] font-[600] border-r-[0.5px] border-gray ${category === "For Rent" ? "text-blue-500" : ""}`}
//                   onClick={() => handleCategoryChange("For Rent")}
//                 >
//                   Rent
//                 </button>
//                 <button
//                   className={`px-5 text-[18px] font-[600] ${category === "For Sale" ? "text-blue-500" : ""}`}
