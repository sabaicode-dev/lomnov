// src/app/[locale]/(pages)/chat/page.tsx
...
//   return (
//     <div className="flex h-screen bg-gray-200 rounded-sm max-w-screen border-1">
//       {/* Conversations Sidebar */}
//       <div className="h-full bg-white rounded-r-sm shadow-sm w-96 border-1">
//         <div className="flex items-center justify-between p-4 mt-20 border-b">
